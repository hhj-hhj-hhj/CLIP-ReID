...
def make_dataloader(cfg):
    ...
    if 'triplet' in cfg.DATALOADER.SAMPLER:
        if cfg.MODEL.DIST_TRAIN:
            ...
            data_sampler_rgb = RandomIdentitySampler_DDP(dataset.train_rgb, cfg.SOLVER.STAGE2.IMS_PER_BATCH,
            ...
            train_loader_stage2_rgb = torch.utils.data.DataLoader(
                ...
                batch_sampler=batch_sampler_rgb,
                collate_fn=train_collate_fn,
                pin_memory=True,
            )
            train_loader_stage2_ir = torch.utils.data.DataLoader(
                train_set_ir,
                num_workers=num_workers,
            ...
            train_loader_stage2_rgb = DataLoader(
                train_set_rgb, batch_size=cfg.SOLVER.STAGE2.IMS_PER_BATCH,
                sampler=RandomIdentitySampler(dataset.train_rgb, cfg.SOLVER.STAGE2.IMS_PER_BATCH,
                                              cfg.DATALOADER.NUM_INSTANCE),
                num_workers=num_workers, collate_fn=train_collate_fn
            )
            train_loader_stage2_ir = DataLoader(
                train_set_ir, batch_size=cfg.SOLVER.STAGE2.IMS_PER_BATCH,
                sampler=RandomIdentitySampler(dataset.train_ir, cfg.SOLVER.STAGE2.IMS_PER_BATCH,
                                              cfg.DATALOADER.NUM_INSTANCE),
                num_workers=num_workers, collate_fn=train_collate_fn
            )
        ...
        train_loader_stage2_rgb = DataLoader(
            train_set_rgb, batch_size=cfg.SOLVER.STAGE2.IMS_PER_BATCH, shuffle=True, num_workers=num_workers,
            collate_fn=train_collate_fn
        )
        train_loader_stage2_ir = DataLoader(
    ...
    train_loader_stage1_rgb = DataLoader(
        train_set_normal_rgb, batch_size=cfg.SOLVER.STAGE1.IMS_PER_BATCH, shuffle=True, num_workers=num_workers,
        collate_fn=train_collate_fn
    )
    train_loader_stage1_ir = DataLoader(
